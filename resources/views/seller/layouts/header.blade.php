		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo" style="height: 80px;width:80px">
						<img src="{{asset('assets')}}/images/icons/logo-03.jpg" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="{{route('seller.product.index')}}">My Products</a>
							</li>
		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					<li class="p-b-13">
						<a href="{{route('seller.dashboard')}}" class="stext-102 cl2 hov-cl1 trans-04">
							Home
						</a>
					</li>
					...
					<li class="p-b-13">
						<a href="{{route('seller.product.index')}}" class="stext-102 cl2 hov-cl1 trans-04">
							My Products
						</a>
					</li>
