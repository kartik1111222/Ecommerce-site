	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<a href="{{route('buyer.all_products')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5">
						All Products
					</a>

					<a href="{{route('buyer.women_product')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5">
						Women
					</a>
					...
					<a href="{{route('buyer.shoes_product')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1">
						Shoes
					</a>

					<a href="{{route('buyer.watch_product')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5">
						Watches
					</a>
				</div>
