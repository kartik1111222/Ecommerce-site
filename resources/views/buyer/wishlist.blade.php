...
<body class="animsition">
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<a href="{{route('buyer.all_products')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1 btn btn-primary">
					Back
				</a>
			</div>
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<button onclick="deleteConfirmation({{$item->id}})"><i class="zmdi zmdi-favorite" style='color: red'></i></button>
							</div>
	...
	<script>
		function deleteConfirmation($id) {
			...
			var url = "{{route('buyer.remove_wishlist',['_id_'])}}";
