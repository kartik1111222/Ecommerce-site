								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="{{asset('assets/images/items/'.$item->item->image)}}" alt="IMG">
										</div>
									</td>
									<td class="column-2">{{$item->item->name}}</td>
									<td class="column-3" id="price">₹ {{$item->item->price}}</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0" id="quantity">
											<button class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m" id="increase">  
												<i class="fs-16 zmdi zmdi-minus"></i>
											</button>

											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="1" id="qty">

											<button class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m" id="decrease">
